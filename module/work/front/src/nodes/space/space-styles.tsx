  ...
  return (
    <style>{`
      ...
      .ws-rich-document-editor {
        ...
        color: #111827;
        padding: 30px 42px;
        font: 17px/2.05 Georgia, "Times New Roman", "Noto Serif SC", serif;
        white-space: pre-wrap;
      }
      ...
      .ws-node-detail-editor-foot button {
        display: inline-flex;
        min-width: 104px;
        height: 38px;
        flex: 0 0 auto;
      ...
      .ws-node-detail-editor-foot button:disabled {
        cursor: not-allowed;
        opacity: 0.58;
        box-shadow: none;
      }
